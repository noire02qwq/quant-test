...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare raw & qlib data for trend-regression-smooth experiment.")
    parser.add_argument("--refresh", action="store_true", help="Rebuild dataset (delete cached files).")
    parser.add_argument(
        "--symbols",
        default="QQQ",
        help="Comma-separated tickers to download (default: QQQ).",
    )
