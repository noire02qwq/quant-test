...
from compute_labels import compute_binary_labels
...
def plot_feature_diagnostics(year: int = 2024, symbol: str = "QQQ") -> Path:
    """输出指定年份的 K 线 + MACD + KDJ 诊断图。"""
...
def prepare_feature_dataframe(feature_mode: str, symbols: Sequence[str] | None = None) -> pd.DataFrame:
    ...
    for symbol in symbol_list:
        ...
        labels = compute_binary_labels(traditional).rename("label")
