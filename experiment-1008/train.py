...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train regression model for experiment-1008")
...
# python experiment-1008/train.py --config experiment-1008/configs/transformer_traditional.json
