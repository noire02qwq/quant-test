...
def plot_trend_timeseries(df: pd.DataFrame, symbol: str, output_path: Path) -> None:
    ...
    ax_price.set_title(f"{symbol} 2024 Candlestick with Trend t-value")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="trend-regression-test/outputs", help="Output directory")
