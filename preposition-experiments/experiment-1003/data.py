...
def main() -> None:
    ...
    3) 保存至 preposition-experiments/experiment-1003/outputs/plots/tsm_2024_overview.png。
    """
    from json import loads

    cfg = loads(Path("preposition-experiments/experiment-1003/config.json").read_text(encoding="utf-8"))
    ...
    _plot_kline_with_subplots(df_2024, Path("preposition-experiments/experiment-1003/outputs/plots/tsm_2024_overview.png"))
