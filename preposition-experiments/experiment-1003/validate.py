...
def main() -> None:
    cfg_path = Path("preposition-experiments/experiment-1003/config.json")
    ...
    print({"val_acc": accuracy(y_true, y_pred), "val_macro_f1": macro_f1(y_true, y_pred, num_classes=num_classes)})
