...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train regression model for preposition-experiments/experiment-1010")
...
# python preposition-experiments/experiment-1010/train.py --config preposition-experiments/experiment-1010/configs/transformer_raw_traditional.json
