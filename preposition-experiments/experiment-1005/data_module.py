...
def prepare_datasets(
    ...
    if not quiet:
        print(
            "[preposition-experiments/experiment-1005] Dataset summary -> "
...
def resolve_symbols(
    ...
    for sym in symbols:
        ...
        try:
            ...
            print(f"[preposition-experiments/experiment-1005] Warning: failed to read {path}: {err}")
            continue
        if df_dates.empty:
            print(f"[preposition-experiments/experiment-1005] Warning: no data rows for {sym}, skipping.")
            continue
    ...
    print(
        "[preposition-experiments/experiment-1005] Symbol filtering -> "
