...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate transformer checkpoints for experiment-1005")
    ...
    if checkpoint_path is None:
        ...
        checkpoint_dir = Path(paths_cfg.get("checkpoint_dir", "experiment-1005/outputs/checkpoints"))
    ...
    print(
        f"[experiment-1005] Dataset (eval) symbol coverage -> train: {train_symbol_count}, val: {val_symbol_count}, test: {test_symbol_count}"
    )
